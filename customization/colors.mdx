---
title: "Customize Dev Arcade's Neon Color Palette"
sidebarTitle: "Colors"
description: "Dev Arcade uses six custom Tailwind color tokens. Learn what each one does and how to swap the arcade palette for your own brand colors."
---
...
::-webkit-scrollbar-thumb {
  background: #b14cff; /* purple-electric */
}

::-webkit-scrollbar-thumb:hover {
  background: #ff3df0; /* magenta-hot */
}

::-webkit-scrollbar-track {
  background: #07060d;              /* arcade */
  border-left: 2px solid #1a0b2e;  /* purple-deep */
}
```
