...
<Note>
  All seven HTML files load the same `assets/main.js` bundle. The only difference between them is the `window.__STATIC_PAGE_ROUTE__` value in the inline script.
</Note>
